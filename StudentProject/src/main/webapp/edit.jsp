...
<body>
	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				<a href="https://www.java.main" class="navbar-brand"> Student Application </a>
			</div>
	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Student Branch</label> <input type="text"
				...
				<fieldset class="form-group">
					<label>Student Percentage</label> <input type="text"
						value="<c:out value='${student.percentage}' />" class="form-control"
						name="percentage" >
				</fieldset>
